...
(export CUDA_VISIBLE_DEVICES=4 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.6 --reward noisy)&
(export CUDA_VISIBLE_DEVICES=5 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.7 --reward noisy)&
(export CUDA_VISIBLE_DEVICES=6 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.8 --reward noisy)&
(export CUDA_VISIBLE_DEVICES=7 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.9 --reward noisy)&
...
(export CUDA_VISIBLE_DEVICES=4 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.6 --reward noisy --smooth True)&
(export CUDA_VISIBLE_DEVICES=5 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.7 --reward noisy --smooth True)&
(export CUDA_VISIBLE_DEVICES=6 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.8 --reward noisy --smooth True)&
(export CUDA_VISIBLE_DEVICES=7 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.9 --reward noisy --smooth True)&
...
(export CUDA_VISIBLE_DEVICES=4 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.6 --reward surrogate)&
(export CUDA_VISIBLE_DEVICES=5 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.7 --reward surrogate)&
(export CUDA_VISIBLE_DEVICES=6 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.8 --reward surrogate)&
(export CUDA_VISIBLE_DEVICES=7 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.9 --reward surrogate)&
...
(export CUDA_VISIBLE_DEVICES=4 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.6 --reward surrogate --smooth True)&
(export CUDA_VISIBLE_DEVICES=5 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.7 --reward surrogate --smooth True)&
(export CUDA_VISIBLE_DEVICES=6 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.8 --reward surrogate --smooth True)&
(export CUDA_VISIBLE_DEVICES=7 && python sarsa_cartpole.py --log_dir $log_dir --error_positive 0.9 --reward surrogate --smooth True)&
done
